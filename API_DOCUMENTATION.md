...
```json
{
  ...
  "archivedAt": null,
  "completedAt": null,
  "createdAt": "2025-07-01T12:41:15.351Z",
  "updatedAt": "2025-07-01T12:41:15.351Z",
  "createdBy": {
    "id": 9,
    "username": "testuser123",
    "firstName": "Test",
...
**Response (200):** Array of task objects (as shown above)
...
**Headers:** `Authorization: Bearer <token>` (optional for public profile data)
...
### Health Check
**GET** `/health` (Note: No `/api` prefix for health endpoint)

**Response (200):**
```json
{
  "status": "OK",
  "timestamp": "2025-07-01T12:40:04.988Z",
  "uptime": 18987.652345008
}
```
